...
<div class="container py-4">
	...
	<div class="row align-items-md-stretch">
		<div class="row">
			<table width="100%">
				<tr>
					<td align="left"><a href="./deleteCart.jsp?cartId=<%=cardId %>" class="btn btn-danger">삭제하기</a></td>
					<td align="right"><a href="./shippingInfo.jsp?cartId=<%=cardId%>" class="btn btn-success">주문하기</a></td>
				</tr>
			</table>
		</div>
